...
import { AudioPost } from '@/lib/audio-posts';

interface EditableVoiceCardProps {
  post: AudioPost;
...
export function EditableVoiceCard({ post, layout = 'desktop', isOwner, userId, handle }: EditableVoiceCardProps) {
  ...
  const handleEdit = () => {
    router.push(`/${handle}/edit/audio/${post.id}`);
  };
  ...
  return (
    <div className="relative group">
      <VoiceCard post={post} layout={layout} />
